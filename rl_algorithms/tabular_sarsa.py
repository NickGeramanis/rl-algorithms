...
class TabularSARSA:
    ...
    def __init__(self, env, learning_rate_midpoint, discount_factor, initial_learning_rate, learning_rate_steepness, discretizer):
        ...
        if not self.logger.handlers:
            ...
            file_handler = logging.FileHandler('info1.log')
        ...
        self.logger.info('Running Tabular SARSA')
        ...
        self.logger.info('Tabular SARSA: discount factor = {}, learning rate midpoint = {}, learning rate steepness = {}, initial learning rate = {}'.format(
